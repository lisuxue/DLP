...
{
  {
    ILP_Object ilptmp28;
    {
      ...
      ILP_Object ilptmp30;
      ILP_Object ilptmp31;
      ilptmp30 = ILP_Integer2ILP (11);
      ilptmp31 = ILP_Integer2ILP (22);
      ilptmp29 = ILP_MakeInstance (Point);
      ilptmp29->_content.asInstance.field[0] = ilptmp30;
      ilptmp29->_content.asInstance.field[1] = ilptmp31;
      ilptmp28 = ilptmp29;
    }

    {
      ILP_Object point3 = ilptmp28;
      {
	ILP_general_function ilptmp32;
	ILP_Object ilptmp33;
	ilptmp33 = point3;
	ilptmp32 = ILP_find_method (ilptmp33, &ILP_object_longueur_method, 1);
	return ilptmp32 (NULL, ilptmp33);
      }
