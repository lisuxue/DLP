...
ilp__print_2 (ILP_Closure ilp_useless, ILP_Object self1)
{
...

  {
	...
	ilptmp634 = ILP_String2ILP ("print@Point2D");
	ilptmp633 = ILP_print (ilptmp634);
      }
      ilptmp633 = ILP_FindAndCallSuperMethod ();
      return ilptmp633;
    }
  }
}
...
{
  {
    ILP_Object ilptmp635;
    {
      ...
      ilptmp637 = ILP_Integer2ILP (8492);
      ilptmp638 = ILP_Integer2ILP (1);
      ilptmp636 = ILP_MakeInstance (Point2D);
      ilptmp636->_content.asInstance.field[0] = ilptmp637;
      ilptmp636->_content.asInstance.field[1] = ilptmp638;
      ilptmp635 = ilptmp636;
    }

    {
      ILP_Object pc3 = ilptmp635;
      {
	...
	if (0 == setjmp (new_catcher._jmp_buf))
	  {
	    ILP_establish_catcher (&new_catcher);
	    {
	      ...
	      {
		ILP_general_function ilptmp640;
		ILP_Object ilptmp641;
		ilptmp641 = pc3;
		ilptmp640 =
		  ILP_find_method (ilptmp641, &ILP_object_print_method, 1);
		ilptmp639 = ilptmp640 (NULL, ilptmp641);
	      }
	      ilptmp639 = ILP_Integer2ILP (8492);
	      return ilptmp639;
	    }
