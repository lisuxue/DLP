...
{
  {
    ILP_general_function ilptmp351;
    ILP_Object ilptmp352;
    {
      ...
      ilptmp354 = ILP_Integer2ILP (11);
      ilptmp355 = ILP_Integer2ILP (22);
      ilptmp356 = ILP_String2ILP ("red");
      ilptmp353 = ILP_MakeInstance (PointColore);
      ilptmp353->_content.asInstance.field[0] = ilptmp354;
      ilptmp353->_content.asInstance.field[1] = ilptmp355;
      ilptmp353->_content.asInstance.field[2] = ilptmp356;
      ilptmp352 = ilptmp353;
    }
    ilptmp351 = ILP_find_method (ilptmp352, &ILP_object_print_method, 1);
    return ilptmp351 (NULL, ilptmp352);
  }
